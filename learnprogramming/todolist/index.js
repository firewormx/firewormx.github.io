import {createTodo, addTodo, countTodos, exportTitles, firstTodoTitle, lastTodoTitle} from "./todolist.js";
...
function render(todos) {
    ...
    todos.forEach(function(todo) {
        list.insertAdjacentHTML("beforeend",
         `<li><div class="card">${todo.icon} &nbsp;<strong>${todo.title}</strong> - by <strong>${todo.author.firstName} ${todo.author.lastName}</strong> in ${todo.category}</div></li>`);
    });
}
